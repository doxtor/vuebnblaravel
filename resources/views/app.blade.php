...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/style.css') }}" type="text/css">
	...
	<script type="text/javascript">
		...
		console.log(JSON.parse(vuebnb_listing_model));
	</script>
</head>
<body>
<div id="toolbar">
...
<div id="app">
  ...
  <div class="container">
	  ...
	  <p v-bind:class="{ terkontrak: terkontrak }">@{{ about }}</p>
	  <button v-if="terkontrak" class="more" v-on:click="terkontrak = false">+ More</button>
	</div>
  	<div class="lists">
		<feature-list title="Amenities">
			<div class="list-item" v-for="amenity in amenities">
				<i class="fa fa-lg" :class="amenity.icon"></i><span>@{{ amenity.title }}</span>
			</div>
		</feature-list>
